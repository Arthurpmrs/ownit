...
class EventType(enum.Enum):
    ...
    STUDY_SESSION_UNDO_STARTED = 'STUDY_SESSION_UNDO_STARTED'
    STUDY_SESSION_UPDATED = 'STUDY_SESSION_UPDATED'
    STUDY_SESSION_FINISHED = 'STUDY_SESSION_FINISHED'
    STUDY_SESSION_CANCELED = 'STUDY_SESSION_CANCELED'
    STUDY_SESSION_UNDO_CANCELED = 'STUDY_SESSION_UNDO_CANCELED'
